...
import { IPerfil } from 'app/entities/JhipsterSemasPortariasMicroservico/perfil/perfil.model';
import { PerfilService } from 'app/entities/JhipsterSemasPortariasMicroservico/perfil/service/perfil.service';
...
describe('Usuario Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Perfil query and add missing value', () => {
      ...
      const perfil: IPerfil = { id: 27942 };
      usuario.perfil = perfil;

      const perfilCollection: IPerfil[] = [{ id: 13157 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const usuario: IUsuario = { id: 456 };
      const setor: ISetor = { id: 16235 };
      usuario.setor = setor;

      const setorCollection: ISetor[] = [{ id: 7660 }];
    ...
    it('Should update editForm', () => {
      const usuario: IUsuario = { id: 456 };
      const perfil: IPerfil = { id: 6285 };
      usuario.perfil = perfil;
      const setor: ISetor = { id: 25593 };
      usuario.setor = setor;
