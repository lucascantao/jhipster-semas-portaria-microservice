...
public class SetorResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSemasPortariasMicroservicoSetor";
    ...
    public ResponseEntity<Setor> createSetor(@Valid @RequestBody Setor setor) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/setors/" + setor.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, setor.getId().toString()))
            .body(setor);
    }
    ...
    public ResponseEntity<Setor> partialUpdateSetor(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, setor.getId().toString())
        );
    }
