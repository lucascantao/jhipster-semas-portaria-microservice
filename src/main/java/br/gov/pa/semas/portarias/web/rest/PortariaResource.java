...
public class PortariaResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSemasPortariasMicroservicoPortaria";
    ...
    public ResponseEntity<Portaria> createPortaria(@Valid @RequestBody Portaria portaria) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/portarias/" + portaria.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, portaria.getId().toString()))
            .body(portaria);
    }
    ...
    public ResponseEntity<Portaria> updatePortaria(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, portaria.getId().toString()))
            .body(portaria);
    }
    ...
    public ResponseEntity<Portaria> partialUpdatePortaria(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, portaria.getId().toString())
        );
    }
