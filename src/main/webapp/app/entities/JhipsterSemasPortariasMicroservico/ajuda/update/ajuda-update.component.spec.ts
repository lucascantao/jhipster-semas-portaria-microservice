...
import { TopicoService } from 'app/entities/JhipsterSemasPortariasMicroservico/topico/service/topico.service';
...
describe('Ajuda Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Topico query and add missing value', () => {
      ...
      const topicos: ITopico[] = [{ id: 'b3b180c3-65c3-4a99-8787-632d27f11370' }];
      ajuda.topicos = topicos;

      const topicoCollection: ITopico[] = [{ id: '8c66549c-e59e-4892-896f-6fb5972bf2df' }];
    ...
    it('Should update editForm', () => {
      const ajuda: IAjuda = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const topico: ITopico = { id: '3fa4dfcf-80b7-410c-99b8-ecffc080ed1c' };
