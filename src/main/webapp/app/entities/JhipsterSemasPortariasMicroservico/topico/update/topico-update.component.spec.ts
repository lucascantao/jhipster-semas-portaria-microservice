...
import { AjudaService } from 'app/entities/JhipsterSemasPortariasMicroservico/ajuda/service/ajuda.service';
...
describe('Topico Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Ajuda query and add missing value', () => {
      ...
      const ajudas: IAjuda[] = [{ id: '7d65f35c-8289-4d5d-b19d-dc9820decd18' }];
      topico.ajudas = ajudas;

      const ajudaCollection: IAjuda[] = [{ id: 'e6371182-7a95-49b7-a927-9778d6bbb183' }];
    ...
    it('Should call Assunto query and add missing value', () => {
      const topico: ITopico = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const assuntos: IAssunto[] = [{ id: 13143 }];
      topico.assuntos = assuntos;

      const assuntoCollection: IAssunto[] = [{ id: 1082 }];
    ...
    it('Should update editForm', () => {
      const topico: ITopico = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const ajuda: IAjuda = { id: 'cd1f60e4-0a33-4b1a-a65e-0e297bbc7e87' };
      topico.ajudas = [ajuda];
      const assunto: IAssunto = { id: 18769 };
