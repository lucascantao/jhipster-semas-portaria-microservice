...
public class AjudaResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSemasPortariasMicroservicoAjuda";
    ...
    public ResponseEntity<Ajuda> createAjuda(@Valid @RequestBody Ajuda ajuda) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ajudas/" + ajuda.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, ajuda.getId().toString()))
            .body(ajuda);
    }
    ...
    public ResponseEntity<Ajuda> updateAjuda(@PathVariable(value = "id", required = false) final UUID id, @Valid @RequestBody Ajuda ajuda)
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ajuda.getId().toString()))
            .body(ajuda);
    }
    ...
    public ResponseEntity<Ajuda> partialUpdateAjuda(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ajuda.getId().toString())
        );
    }
