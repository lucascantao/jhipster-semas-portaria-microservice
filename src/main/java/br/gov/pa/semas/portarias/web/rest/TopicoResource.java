...
public class TopicoResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSemasPortariasMicroservicoTopico";
    ...
    public ResponseEntity<Topico> createTopico(@Valid @RequestBody Topico topico) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/topicos/" + topico.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, topico.getId().toString()))
            .body(topico);
    }
    ...
    public ResponseEntity<Topico> updateTopico(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, topico.getId().toString()))
            .body(topico);
    }
    ...
    public ResponseEntity<Topico> partialUpdateTopico(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, topico.getId().toString())
        );
    }
