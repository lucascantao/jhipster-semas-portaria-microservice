...
import { AssuntoService } from 'app/entities/JhipsterSemasPortariasMicroservico/assunto/service/assunto.service';
import { ISetor } from 'app/entities/JhipsterSemasPortariasMicroservico/setor/setor.model';
import { SetorService } from 'app/entities/JhipsterSemasPortariasMicroservico/setor/service/setor.service';
import { IUsuario } from 'app/entities/JhipsterSemasPortariasMicroservico/usuario/usuario.model';
import { UsuarioService } from 'app/entities/JhipsterSemasPortariasMicroservico/usuario/service/usuario.service';
...
describe('Portaria Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Assunto query and add missing value', () => {
      ...
      const assunto: IAssunto = { id: 9946 };
      portaria.assunto = assunto;

      const assuntoCollection: IAssunto[] = [{ id: 12005 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const portaria: IPortaria = { id: 456 };
      const setor: ISetor = { id: 28491 };
      portaria.setor = setor;

      const setorCollection: ISetor[] = [{ id: 13713 }];
    ...
    it('Should call Usuario query and add missing value', () => {
      const portaria: IPortaria = { id: 456 };
      const usuario: IUsuario = { id: 3498 };
      portaria.usuario = usuario;
      const updatedBy: IUsuario = { id: 10818 };
      portaria.updatedBy = updatedBy;
      const deletedBy: IUsuario = { id: 11421 };
      portaria.deletedBy = deletedBy;

      const usuarioCollection: IUsuario[] = [{ id: 8563 }];
    ...
    it('Should update editForm', () => {
      const portaria: IPortaria = { id: 456 };
      const assunto: IAssunto = { id: 5427 };
      portaria.assunto = assunto;
      const setor: ISetor = { id: 11795 };
      portaria.setor = setor;
      const usuario: IUsuario = { id: 437 };
      portaria.usuario = usuario;
      const updatedBy: IUsuario = { id: 23792 };
      portaria.updatedBy = updatedBy;
      const deletedBy: IUsuario = { id: 16067 };
      portaria.deletedBy = deletedBy;
