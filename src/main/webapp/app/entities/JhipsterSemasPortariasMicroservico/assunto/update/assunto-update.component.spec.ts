...
describe('Assunto Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Topico query and add missing value', () => {
      ...
      const topicos: ITopico[] = [{ id: '8667c253-bb31-4eae-8de8-978e729ec9a7' }];
      assunto.topicos = topicos;

      const topicoCollection: ITopico[] = [{ id: '71ac3811-ecc2-464d-9428-eee570ab9e3a' }];
    ...
    it('Should update editForm', () => {
      const assunto: IAssunto = { id: 456 };
      const topico: ITopico = { id: 'ee02bf06-9ea6-4607-97a9-e1211c53863d' };
