...
public class PerfilResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSemasPortariasMicroservicoPerfil";
    ...
    public ResponseEntity<Perfil> createPerfil(@Valid @RequestBody Perfil perfil) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/perfils/" + perfil.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, perfil.getId().toString()))
            .body(perfil);
    }
    ...
    public ResponseEntity<Perfil> partialUpdatePerfil(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, perfil.getId().toString())
        );
    }
